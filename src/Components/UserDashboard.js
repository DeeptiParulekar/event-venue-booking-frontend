...
import axios from "axios";
import "./UserDashboard.css";
import { FaBuilding, FaCalendarCheck, FaClock, FaRupeeSign, FaTimesCircle } from "react-icons/fa";
import CountUp from "react-countup";
    ...
    <div className="dashboard-container">
      ...
      <div className="metrics">
        ...
        <div className="metric-card">
          ...
          <p>₹ <CountUp end={metrics.totalAmountSpent} duration={1.5} separator="," /></p>
        </div>

        <div className="metric-card">
          <FaTimesCircle size={30} className="metric-icon" />
          <h3>Total Cancellations</h3>
          <p><CountUp end={metrics.totalCancellations} duration={1.5} /></p>
        </div>
      </div>
